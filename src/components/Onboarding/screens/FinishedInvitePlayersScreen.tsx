...
import { updateActiveClubAction } from '../../../redux/slices/clubsSlice';
...
const FinishedInvitePlayersScreen = () => {
  const navigation = useNavigation();
  const dispatch = useAppDispatch();

  const handleNextStep = () => {
    dispatch(updateActiveClubAction({ onboarded: true as any }));
        ...
        <View style={styles.boxContainer}>
          ...
          <View style={[styles.marginTop50, styles.textWidth]}>
            <Text style={[styles.centerText, styles.mainText]}>
              Success! You’ve now invited your Players
            </Text>
          </View>
          <View style={[styles.marginTop20, styles.textWidth]}>
            <Text style={[styles.centerText, styles.subText]}>
              You can always edit their settings or add more by navigating to
              the Players tab.
            </Text>
          </View>
          <View style={styles.bottomContainer}>
            ...
            <View style={styles.circleContainer}>
              <TouchableOpacity onPress={handleNextStep}>
                <OnboardingProgressCircle percentage={100} checkmark />
...
export default FinishedInvitePlayersScreen;
